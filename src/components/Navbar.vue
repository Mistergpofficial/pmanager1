<template>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand" href="/">PMan<span>ager</span></a>
        </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
                        <li class="active" v-if="!isAuth"><a href="index.html">Home</a></li>
                        <li v-if="!isAuth"><a href="about-us.html">About Us</a></li>
                        <li v-if="!isAuth"><a href="services.html">Services</a></li>
                        <li v-if="!isAuth"><a href="portfolio.html">Portfolio</a></li>
                         <li v-if="!isAuth"><a href="#" data-target="#login" data-toggle="modal">Sign in</a></li>
                        <li class="btn-trial" v-if="!isAuth"><a href="#footer">Free Trail</a></li>
                        <li v-if="isAuth"><a href="/companies"><i class="fa fa-building" aria-hidden="true"></i>Companies</a></li>
                        <li v-if="isAuth"><a href="/projects"><i class="fa fa-briefcase" aria-hidden="true"></i>Projects</a></li>
                        <li v-if="isAuth"><a href=""><i class="fa fa-tasks" aria-hidden="true"></i>Tasks</a></li>

            <li class="dropdown" v-if="isAuth && loggedInUser.role_id == 1 " >
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="/users"><i class="fa fa-users" aria-hidden="true"></i>All Users</a></li>
            ...
            <li class="dropdown" v-if="isAuth">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>{{ loggedInUser.full_name }} </a>
                            <ul class="dropdown-menu">
                                <li><a @click.prevent="logout" href=""><i class="fa fa-sign-out fa-2x"></i> Logout</a></li>
                            </ul>
                        </li>                       
                    </ul>
                </div>
            ...
            setAuthenticatedUser () {
             ...
             logout() {
              this.$http.post(logoutUrl)
                    .then(response => {
                        this.$auth.destroyToken(response.body.access_token, response.body.expires_in + Date.now())
                        window.location = '/'
